...
public class Fraginsidevisibility extends FragmentPagerAdapter {
    private List<Fragment> fragmentList1;
    private List<String> titleList1;
    public Fraginsidevisibility(FragmentManager manager, List<Fragment> fragmentList1, List<String> titleList1){
        super(manager);
