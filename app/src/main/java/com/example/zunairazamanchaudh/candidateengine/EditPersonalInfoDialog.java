...
public class EditPersonalInfoDialog extends DialogFragment implements View.OnClickListener {
...
ProgressBar progressBareditProfile;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_edit_personal_info_dialog, container, false);
        editLname=(EditText)view.findViewById(R.id.editLname);
        editFname=(EditText)view.findViewById(R.id.editFname);
        progressBareditProfile=(ProgressBar)view.findViewById(R.id.progressBareditProfile);
        editdob=(EditText)view.findViewById(R.id.editdob);
        Currentpasswd=(EditText)view.findViewById(R.id.CurrentPassword);
        editphone=(EditText)view.findViewById(R.id.editphone);
        editemail=(EditText)view.findViewById(R.id.editemail);
        editNationality=(EditText)view.findViewById(R.id.editnationality);
        editCurCity=(EditText)view.findViewById(R.id.editCurCity);
        editCurCountry=(EditText)view.findViewById(R.id.editCurCountry);
        editCurState=(EditText)view.findViewById(R.id.editCurState);
        editCurzipcode=(EditText)view.findViewById(R.id.editCurzipcode);
        saveEditProfiledetails=(Button)view.findViewById(R.id.saveEditProfiledetails);
        cancelEditPdetails=(Button)view.findViewById(R.id.cancelEditPdetails);
    ...
    private void updateinfo(){
        ...
        if(!editemail.getText().toString().equals(FirebaseAuth.getInstance().getCurrentUser().getEmail())){
            ...
            if(!isEmpty(editemail.getText().toString()) && !isEmpty(Currentpasswd.getText().toString())){
                ...
                Toast.makeText(getActivity(), "Email  and password Must be Filled to Save", Toast.LENGTH_SHORT).show();
            }
        }
                /*
                        ...
                        if(task.isSuccessful()){
                            ...
                            if(isValidDomain(editemail.getText().toString())){
                               //  checkprovidersavailable();
                                ...
                                Toast.makeText(getActivity(), "you must use a company email", Toast.LENGTH_SHORT).show();
                            }
